...
@like_routes.route('/post/likes/<int:post_id>',methods=['GET'])
...
@like_routes.route('/user/likes/<int:user_id>',methods=['GET'])
def get_user_likes():
...
@like_routes.route('/posts/<int:postid>/likes',methods=['DELETE'])
@login_required
def remove_like(id):
    like_delete = Like.query.get(id)
