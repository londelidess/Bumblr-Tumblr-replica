...
def seed_medias():
    ...
    media21 = Media(post_id=20, media_type='image', media_url='https://placeholder.com/image5.jpg')
    media22 = Media(post_id=21, media_type='image', media_url='https://placeholder.com/image6.jpg')
    media23 = Media(post_id=22, media_type='image', media_url='https://placeholder.com/image7.jpg')
    media24 = Media(post_id=23, media_type='image', media_url='https://placeholder.com/image8.jpg')
    media25 = Media(post_id=24, media_type='image', media_url='https://placeholder.com/image9.jpg')
    media26 = Media(post_id=25, media_type='image', media_url='https://placeholder.com/image10.jpg')
    media27 = Media(post_id=26, media_type='image', media_url='https://placeholder.com/image11.jpg')
    media28 = Media(post_id=27, media_type='image', media_url='https://placeholder.com/image12.jpg')
    media29 = Media(post_id=28, media_type='image', media_url='https://placeholder.com/image13.jpg')
    media30 = Media(post_id=29, media_type='image', media_url='https://placeholder.com/image14.jpg')
    media31 = Media(post_id=30, media_type='image', media_url='https://placeholder.com/image15.jpg')
